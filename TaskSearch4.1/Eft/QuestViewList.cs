    ...
    internal sealed class QuestViewList
    {
        ...
        private static FieldInfo ResolveViewListField()
        {
            ...
            foreach (FieldInfo field in fields)
            {
                ...
                if (args.Length != 2 || args[0] != typeof(Quest) || args[1] != typeof(NotesTask))
                {
                    continue;
                }
        ...
        internal void Filter(Func<Quest, bool> predicate)
        {
            try
            {
        ...
        internal void SetOrder(IEnumerable<Quest> orderedQuests)
        {
