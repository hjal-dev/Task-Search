...
namespace TaskSearch.Search
{
    internal static class TaskSearchEntryBuilder
    {
        ...
        internal static TaskSearchEntry Build(QuestClass quest, Func<string, string> resolveQuestName)
        {
            if (quest == null)
            {
                return null;
            ...
            RawQuestClass template = SafeGet(() => quest.Template, null);
        ...
        private static void AddDescription(TaskSearchEntry entry, RawQuestClass template, string questId)
        {
        ...
        private static void AddTrader(TaskSearchEntry entry, RawQuestClass template, string questId)
        {
        ...
        private static void AddQuestLocation(TaskSearchEntry entry, RawQuestClass template, string questId)
        {
        ...
        private static void AddQuestType(TaskSearchEntry entry, RawQuestClass template, string questId)
        {
        ...
        private static void AddConditions(
            TaskSearchEntry entry, RawQuestClass template, string questId, Func<string, string> resolveQuestName)
        {
