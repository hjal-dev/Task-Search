...
namespace TaskSearch.UI
{
    internal sealed class TaskSearchController : MonoBehaviour
    {
        ...
        private List<QuestClass> _unfilteredOrder = new List<QuestClass>();
        ...
        internal static TaskSearchController Attach(TasksPanel panel, AbstractQuestControllerClass questController)
        {
            if (panel == null)
            {
                return null;
        ...
        private void RebuildIndex(AbstractQuestControllerClass questController)
        {
        ...
        internal void OnQuestListRebuilt()
        {
            ...
            {
                _viewList = null;
                _unfilteredOrder = new List<QuestClass>();
                return;
            }
        ...
        private void ApplyQuery()
        {
            ...
            HashSet<QuestClass> matched = new HashSet<QuestClass>();
            List<QuestClass> ordered = new List<QuestClass>(_unfilteredOrder.Count);

            if (_query.IsEmpty)
            {
                foreach (QuestClass quest in _unfilteredOrder)
                {
        ...
        private bool IsPinnedIfRequired(QuestClass quest)
        {
            if (!_pinnedOnly)
            {
                return true;
